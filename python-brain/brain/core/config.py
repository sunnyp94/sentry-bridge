...
# -----------------------------------------------------------------------------
# Limit orders (reduce slippage; buy below mid, sell above mid). Always True (no env override).
# -----------------------------------------------------------------------------
...
# Market close ET: execution phase ends; discovery script sleeps until 7am next day. Default 16:00 = 4pm ET (13:00 on half-days if set).
